...
namespace ATBM_HTTT
{
    public partial class CapNhatNhanvien : Form
    {
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string query = @"QLTGDA.SP_NHANSU_CAPNHAT_NHANVIEN";
                ...
                {
                    MessageBox.Show("lỗi cập nhật nhân viên :" + ex.Message.ToString());
        ...
        private void textBox_MaQL_TextChanged(object sender, EventArgs e)
        {
